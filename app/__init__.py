...
#  Creates and configures the Flask application, initializes extensions, registers blueprints, and prepares the project to run.
def create_app(config_name=None):
    ...
    #  Reloads the authenticated user from the database using the ID stored in the Flask-Login session.
    ...
    #  Adds security headers to the relevant application or database context.
    @app.after_request
    ...
    # --- error handlers ---
# Implements the forbidden operation used by this module.
    @app.errorhandler(403)
    def forbidden(e):
        return render_template("errors/403.html"), 403

# Implements the not found operation used by this module.
    @app.errorhandler(404)
    def not_found(e):
        return render_template("errors/404.html"), 404

# Implements the unauthorized operation used by this module.
