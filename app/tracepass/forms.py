...
# Defines the product form class and groups its related data and behavior.
...
# Defines the batch form class and groups its related data and behavior.
...
# Defines the material link form class and groups its related data and behavior.
...
# Defines the event form class and groups its related data and behavior.
...
# Defines the shipment form class and groups its related data and behavior.
...
# Defines the lifecycle event form class and groups its related data and behavior.
