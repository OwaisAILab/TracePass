...
#  Automated test that verifies the expected behavior of no active ecommerce blueprint or routes.
...
#  Automated test that verifies the expected behavior of single public verify route.
...
#  Automated test that verifies the expected behavior of final release has security and deployment baseline.
...
#  Automated test that verifies the expected behavior of general dpp has no store scope in readme.
