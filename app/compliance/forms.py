...
# Defines the certificate form class and groups its related data and behavior.
...
# Defines the certificate review form class and groups its related data and behavior.
...
# Defines the document form class and groups its related data and behavior.
...
# Defines the compliance rule form class and groups its related data and behavior.
...
# Defines the compliance requirement form class and groups its related data and behavior.
...
# Defines the review form class and groups its related data and behavior.
