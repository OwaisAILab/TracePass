...
#  Checks whether password strength satisfies the project rules before processing continues.
...
# Defines the login form class and groups its related data and behavior.
...
# Defines the registration form class and groups its related data and behavior.
...
# Defines the admin create user form class and groups its related data and behavior.
class AdminCreateUserForm(FlaskForm):
    ...
    #  Checks whether organization id satisfies the project rules before processing continues.
...
# Defines the email otpform class and groups its related data and behavior.
